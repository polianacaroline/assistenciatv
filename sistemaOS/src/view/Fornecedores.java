...
public class Fornecedores extends JDialog {
	...
	public Fornecedores() {
		...
		setBounds(100, 100, 837, 522);
		getContentPane().setLayout(null);
		setLocationRelativeTo(null);

		scrollPaneFor = new JScrollPane();
		scrollPaneFor.setVisible(false);
		scrollPaneFor.setBounds(20, 102, 321, 33);
		...
		lblTitulo.setBounds(305, 0, 278, 38);
		panel.add(lblTitulo);

		JPanel panel_1 = new JPanel();
		panel_1.setBounds(-33, 444, 876, 56);
	...
	/**
	 * Metodo responsavel por: adicionar fornecedores;
	 */
		...
		if (txtRazao.getText().isEmpty()) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null,
						"Cliente não adicionado.\nEste(a) RAZÃO SOCIAL, CNPJ e/ou EMAIL já está sendo utilizado.");
	...
	/**
	 * Metodo responsavel por: editar fornecedor.
	 */
	...
	/**
	 * Metodo responsavel por: excluir fornecedor.
	 */
